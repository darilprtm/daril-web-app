                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center p-6 lg:p-10">
                                <span className="font-logo text-3xl md:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-black to-black/60">DARIL</span>
                                <button
                            ...
                            >
                                <p className="text-xs md:text-sm font-bold tracking-widest uppercase text-black/40">© 2026 DARIL WEB INDONESIA. ALL RIGHTS RESERVED.</p>
                            </motion.div>
                        </motion.div>
                    </motion.div>
                )}
