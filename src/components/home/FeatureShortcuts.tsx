...
export default function FeatureShortcuts() {
    ...
    const secondaryFeatures = [
        ...
        },
        {
            ...
            icon: Flame,
            href: "/lentera",
            className: "bg-slate-950 text-white border-none md:col-span-2",
            hoverClass: "hover:scale-[1.02] hover:shadow-2xl hover:shadow-black/20",
            iconClass: "text-amber-400 bg-white/10",
            arrowClass: "text-white/50 group-hover:text-amber-400"
        },
        {
            title: lang === 'ID' ? "Kisah Islami" : "Islamic Stories",
            desc: "Belajar Sejarah Nabi & Rasul gaya kekinian.",
            icon: PlayCircle,
            href: "/stories",
            className: "bg-gradient-to-br from-orange-500 to-amber-600 text-white border-none md:col-span-4 lg:col-span-4",
            hoverClass: "hover:scale-[1.01] hover:shadow-2xl hover:shadow-orange-500/40",
            iconClass: "text-white bg-white/20",
            arrowClass: "text-white/50 group-hover:text-white"
        },
        {
            title: lang === 'ID' ? "Ruang Tenang" : "Soul Healing",
            desc: "Terapi emosi dengan Al-Quran & Doa.",
            icon: Sparkles,
            href: "/healing",
            className: "bg-gradient-to-r from-indigo-900 via-fuchsia-900 to-black text-white border-none md:col-span-4 lg:col-span-4 mt-2",
            hoverClass: "hover:scale-[1.01] hover:shadow-2xl hover:shadow-fuchsia-900/40",
            iconClass: "text-white bg-white/10",
            arrowClass: "text-white/50 group-hover:text-white"
        },
    ];
        ...
        <section className="px-4 max-w-7xl mx-auto py-16 mb-12 border-t border-black/5">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
                <div>
                    ...
                    <h2 className="text-4xl md:text-5xl font-black font-serif tracking-tight mb-3">Ekosistem Sasuke.id.</h2>
                    <p className="text-black/60 text-base md:text-lg max-w-xl leading-relaxed">Semua alat yang Anda butuhkan untuk rutinitas Ibadah digital, didesain ulang untuk kenyamanan ekstra.</p>
                </div>
            </div>
            ...
            {/* Quick Links Row */}
            <div className="grid grid-cols-2 sm:grid-cols-3 mx-auto lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 mt-8">
